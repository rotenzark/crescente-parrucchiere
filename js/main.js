...
(function () {
  ...
  var translations = {
    it: {
      ...
      g_note: 'Le foto della bottega arrivano col primo sopralluogo: lo spazio, qui, è già pronto.',
      ...
      closed: 'chiuso',
      closed2: 'chiuso',
      hours_note: 'Orario continuato. Si riceve anche su appuntamento: una telefonata basta.',
    ...
    en: {
      ...
      g_note: 'Photos of the shop are coming with our first visit — the space here is ready for them.',
      ...
      closed: 'closed',
      closed2: 'closed',
      hours_note: 'Open all day, no lunch break. Appointments welcome — just call ahead.',
